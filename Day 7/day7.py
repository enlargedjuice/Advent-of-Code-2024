...
def order_ignorer(items):
    ...
    for i in range(1, len(items), 2):
        ...
        if operator == '+':
            ...
            newn = concatenator(result,number)
            result = newn    
    return result
...
print(f"Sum of correct values with concatenation: {sum(problem_checker2(answers,numbers))}")
